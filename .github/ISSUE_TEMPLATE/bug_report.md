---
name: "🐛 Bug Report"
about: Report a bug if something isn't working as expected in Paid Memberships Pro - Group Discount Codes.
title: ''
labels: 'bug'
assignees: ''
...
<details>
```
Please share non-sensitive information about your hosting environment such as WordPress version, PHP version, Paid Memberships Pro, Paid Memberships Pro - Group Discount Codes and any related plugins versions.
```
</details>
